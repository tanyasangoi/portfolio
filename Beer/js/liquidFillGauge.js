...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var textFinalValue = 100; //parseFloat(value).toFixed(2);
    var textStartValue = 0; //config.valueCountUp?config.minValue:textFinalValue;
    ...
    //var waveColorScale = d3.scaleLinear()
      //  .range()
        //.domain();
