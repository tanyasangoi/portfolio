...
// Determine a suitable range of the temperature scale
    var domain = [
        /*step * Math.floor(0 / step),*/
        0, step * Math.ceil(250 / step)
    ];
...
function changeTemp(x, y, z) {

    d3.select("#temp").transition().duration(x)
        .attr("y", y)
        .attr("height", z);
}